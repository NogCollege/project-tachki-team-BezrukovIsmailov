...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 21 2024 г., 13:38
...
(1, 1, 'BMW ', 'Ногинск', 'Внедорожник', 'BMW X2', 2021, 'Бензин', 2, 190, 10250, 9524, 8799, ' Абсолютно уникальный. Экстремально необычный автомобиль. Новый BMW X2 с первого взгляда показывает свою спортивную сущность.\n\n\nМощный и атлетичный, он предлагает динамику и манёвренность, которые в этом классе автомобилей не имеют себе равных.'),
